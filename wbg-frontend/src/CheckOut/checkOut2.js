    ...
    useEffect(() => {
        const checkStatus = async () => {
            ...
            if (response.data.EC === "0") {
                if (
                    response.data.DT.status === "Đang giao hàng" ||
                    response.data.DT.status === "Thành công"
                )
                    successFully();
            }
        };
        ...
        <>
            <div className="w-full">
                ...
                <div className="grid grid-cols-2 bg-gray-200">
                    <div className="col-span-1 border border-gray-300 py-2 px-2">Chủ tài khoản</div>
                ...
                <div className="grid grid-cols-2 bg-gray-200">
                    <div className="col-span-1 border border-gray-300 py-2 px-2">Ngân hàng</div>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="text-red-500 font-bold text-center mt-5">
                    *Lưu ý: Vui lòng đợi 1-5 phút để hệ thống tự động xác nhận thanh toán. Không làm
                    mới trang hoặc thoát khỏi trang web trong quá trình chờ đợi!
                </div>
            </div>
        </>
    );
    const left2 = <CheckOut3 />;
        ...
        <>
            <div className="flex justify-center flex-col items-center">
                <div className="w-[1300px] mt-5">
                    <div
                        className="font-semibold py-2 text-2xl cursor-pointer"
                        onClick={() => navigate("/")}
                    >
                        <span>SNEAKER VIET</span>
                    </div>
                    <div className="flex flex-row gap-20 mt-5">
                        <div className="left-sec basis-[55%]">{changeContent ? left2 : left1}</div>
                        <div className="right-sec basis-[45%]">
